...
//Header files
#include "MonLIS3DSH.h"

//SPI Chip Select
#define LIS3DHS_CS_ENBALE		HAL_GPIO_WritePin(GPIOE, GPIO_PIN_3, GPIO_PIN_RESET);
#define LIS3DHS_CS_DISABLE	HAL_GPIO_WritePin(GPIOE, GPIO_PIN_3, GPIO_PIN_SET);
...
//2. Sensitivity value
static double lis3dsh_Sensitivity = LIS3DSH_SENSITIVITY_0_06G;
//3. bias variables
...
LIS3DSH_DataScaled LIS3DSH_GetDataScaled(void)
{
	...
	tempScaledData.x = (tempRawData.x * lis3dsh_Sensitivity * X_Scale)  - X_Bias;
	tempScaledData.y = (tempRawData.y * lis3dsh_Sensitivity * Y_Scale)  - Y_Bias;
	tempScaledData.z = (tempRawData.z * lis3dsh_Sensitivity * Z_Scale)  - Z_Bias;
